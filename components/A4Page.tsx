      ...
      >
        ...
        <div className="flex-1 flex flex-col p-8 sm:p-10 md:p-12 pr-6 border-r border-slate-100">
          ...
          <div className="mt-auto pt-8 text-slate-400 text-xs font-sans">
             CV Interactivo • Gonzalo Segura Taguas
          </div>
        </div>
        ...
        <div className="w-56 flex-shrink-0 flex flex-col py-10 px-5 bg-white">
          ...
          <div className="flex flex-col items-center text-center mb-6">
            ...
            <div className="text-[9px] text-slate-500 space-y-1.5 font-medium w-full border-t border-slate-100 pt-3">
              <p className="truncate">{RESUME_DATA.personalInfo.location}</p>
              <a 
              ...
              >
                ...
                <span className="font-semibold text-[10px] tracking-wide">{RESUME_DATA.personalInfo.email}</span>
              </a>
            </div>
          </div>
          ...
          {/* Index Menu */}
          <div className="mb-6">
            <h3 className="text-xs font-bold uppercase tracking-widest text-slate-400 mb-4 pb-1">Índice</h3>
          ...
          <div className="mb-8 flex-grow">
             ...
             <div className="flex flex-col gap-1.5">
               {RESUME_DATA.qualifiedRoles.map((role, i) => (
          ...
          <div className="mt-auto pt-6 border-t border-slate-100">
            ...
            <div className="text-center text-[9px] text-slate-300 uppercase tracking-widest">
              Pág {pageNumber} / {menuItems.length}
            </div>
          </div>
        </div>
      </div>
